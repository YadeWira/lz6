...
Last full sweep: 2026-09-25, v1.6.6-pre (offset low bits in the entropy
coder, ~2.5x faster encode at levels 1-3). fastlzma2 / uf-lzma2 / memlz rows are
...
1.4.0 were not re-measured: per its author, nothing changed since 1.2.0 on the
path lzbench uses (native one-shot UF2_compressMt / UF2_decompressMt; 1.3/1.4
add .xz and streaming), and compressed sizes still match fastlzma2 at levels
1/6/10.
...
|---|---:|---:|---:|---:|
| **lz6 seq -15** | 5,094,075 | 38.78% | 1.7 | 432.1 |
| **lz6 seq -14** | 5,094,961 | 38.79% | 2.3 | 432.7 |
| **lz6 seq -13** | 5,097,074 | 38.80% | 3.4 | 435.1 |
| **lz6 seq -12** | 5,106,481 | 38.87% | 6.5 | 437.7 |
| **lz6 seq -11** | 5,109,494 | 38.90% | 9.2 | 438.1 |
| **lz6 seq -10** | 5,111,229 | 38.91% | 9.5 | 437.9 |
| **lz6 seq -9** | 5,126,425 | 39.02% | 10.3 | 435.1 |
| **lz6 seq -8** | 5,150,050 | 39.20% | 12.4 | 433.1 |
| **lz6 seq -7** | 5,218,685 | 39.73% | 22.5 | 420.1 |
| **lz6 seq -6** | 5,237,226 | 39.87% | 23.9 | 414.9 |
| **lz6 seq -5** | 5,253,577 | 39.99% | 27.6 | 411.9 |
| **lz6 seq -4** | 5,291,041 | 40.28% | 32.4 | 406.0 |
| **lz6 seq -3** | 5,368,634 | 40.87% | 105.4 | 427.6 |
| **lz6 seq -2** | 5,439,439 | 41.41% | 141.0 | 434.7 |
| **lz6 seq -1** | 5,569,779 | 42.40% | 165.9 | 443.6 |
| uf-lzma2 L11 | 6,914,570 | 52.64% | 2.2 | 64.8 |
| brotli L11 | 7,041,245 | 53.60% | 0.6 | 225.4 |
...
| xz L6 | 7,114,024 | 54.16% | 4.0 | 69.5 |
| xz L9 | 7,114,024 | 54.16% | 3.3 | 68.6 |
| fastlzma2 L1 | 7,330,324 | 55.80% | 16.3 | 49.3 |
| uf-lzma2 L1 | 7,330,324 | 55.80% | 16.4 | 70.4 |
| zstd L19 | 7,351,946 | 55.97% | 5.5 | 1088.9 |
| xz L3 | 7,379,360 | 56.18% | 6.5 | 68.0 |
| xz L1 | 7,435,760 | 56.60% | 8.9 | 65.8 |
| brotli L9 | 7,468,536 | 56.85% | 13.9 | 317.4 |
| brotli L6 | 7,489,339 | 57.01% | 34.0 | 317.1 |
| zstd L15 | 7,530,938 | 57.33% | 13.8 | 1019.3 |
| zstd L12 | 7,552,509 | 57.49% | 37.5 | 1014.9 |
| zstd L9 | 7,578,176 | 57.69% | 69.9 | 1020.6 |
| brotli L4 | 7,591,522 | 57.79% | 82.5 | 341.6 |
| zstd L5 | 7,619,521 | 58.00% | 129.4 | 987.9 |
| zstd L3 | 7,695,386 | 58.58% | 192.0 | 1075.6 |
| zlib L9 | 7,786,253 | 59.27% | 7.2 | 313.8 |
| zlib L6 | 7,814,687 | 59.49% | 20.7 | 305.3 |
| brotli L1 | 7,855,241 | 59.80% | 267.8 | 298.0 |
| zstd L1 | 7,869,981 | 59.91% | 439.7 | 1381.1 |
| lizard L49 | 8,041,060 | 61.21% | 5.5 | 1553.4 |
| zlib L1 | 8,094,068 | 61.62% | 54.8 | 305.6 |
| lizard L45 | 8,253,375 | 62.83% | 17.8 | 1559.4 |
| lizard L40 | 8,481,600 | 64.57% | 333.4 | 1516.9 |
| lz5 HC L15 | 8,603,507 | 65.49% | 2.2 | 993.6 |
| lz5 HC L12 | 8,720,302 | 66.38% | 11.8 | 1065.8 |
| lizard L30 | 8,756,123 | 66.66% | 455.9 | 1934.1 |
| misa77 L3 | 8,867,044 | 67.50% | 10.2 | 5541.6 |
| lz5 HC L9 | 8,900,815 | 67.76% | 21.8 | 1164.7 |
| **lz6 HC -15** | 8,996,054 | 68.48% | 11.0 | 1670.0 |
| **lz6 HC -12** | 8,996,268 | 68.48% | 11.4 | 1666.4 |
| lz5 HC L6 | 9,066,986 | 69.02% | 42.6 | 1528.0 |
| misa77 L4 | 9,070,575 | 69.05% | 7.7 | 3504.9 |
| **lz6 HC -6** | 9,190,747 | 69.96% | 44.0 | 1608.0 |
| misa77 L2 | 9,287,323 | 70.70% | 38.8 | 6591.7 |
| lz5 | 9,469,498 | 72.09% | 325.3 | 1260.6 |
| misa77 L0 | 9,554,603 | 72.73% | 203.3 | 7293.0 |
| misa77 L1 | 9,628,088 | 73.29% | 50.9 | 7788.8 |
| lizard L20 | 9,761,531 | 74.31% | 452.9 | 2507.8 |
| lizard L10 | 9,926,082 | 75.56% | 635.4 | 4728.7 |
| lz4 | 9,938,605 | 75.66% | 790.9 | 5088.4 |
| misa77 L-1 | 10,041,718 | 76.44% | 326.9 | 7435.8 |
| lz5 HC L1 | 10,441,177 | 79.48% | 538.6 | 2533.3 |
...
| xz L9 | 48,795,480 | 23.02% | 2.6 | 112.0 |
| brotli L11 | 50,328,370 | 23.75% | 0.5 | 371.2 |
| fastlzma2 L5 | 51,124,925 | 24.12% | 5.9 | 77.9 |
| uf-lzma2 L5 | 51,124,925 | 24.12% | 6.1 | 107.0 |
| zstd L19 | 52,891,946 | 24.96% | 2.8 | 789.2 |
| **lz6 seq -15** | 53,902,064 | 25.43% | 0.7 | 556.9 |
| **lz6 seq -13** | 54,033,023 | 25.49% | 1.4 | 566.4 |
| **lz6 seq -12** | 54,362,516 | 25.65% | 2.8 | 568.9 |
| **lz6 seq -10** | 55,320,016 | 26.10% | 4.4 | 562.6 |
| **lz6 seq -8** | 58,052,310 | 27.39% | 8.3 | 524.0 |
| xz L1 | 58,716,448 | 27.70% | 16.0 | 98.3 |
| fastlzma2 L1 | 58,993,508 | 27.84% | 17.8 | 65.1 |
| uf-lzma2 L1 | 58,993,508 | 27.84% | 18.1 | 96.4 |
| **lz6 seq -7** | 59,710,849 | 28.17% | 16.2 | 490.8 |
| lizard L49 | 60,667,327 | 28.62% | 1.9 | 1200.3 |
| zstd L5 | 62,751,501 | 29.61% | 100.3 | 781.7 |
| **lz6 seq -4** | 63,630,196 | 30.02% | 27.3 | 436.5 |
| lz5 HC L15 | 65,595,195 | 30.95% | 2.2 | 741.4 |
| **lz6 seq -2** | 67,504,846 | 31.85% | 95.8 | 464.3 |
| zlib L6 | 68,220,487 | 32.19% | 26.7 | 331.4 |
| **lz6 seq -1** | 70,837,510 | 33.42% | 106.3 | 456.6 |
| zstd L1 | 73,229,468 | 34.55% | 354.4 | 1204.9 |
| brotli L1 | 73,429,961 | 34.65% | 210.1 | 335.0 |
| zlib L1 | 77,246,811 | 36.45% | 84.6 | 308.9 |
| misa77 L3 | 80,028,169 | 37.76% | 11.0 | 4599.7 |
| lz5 HC L6 | 80,576,517 | 38.02% | 47.7 | 1179.8 |
| **lz6 HC -15** | 81,308,486 | 38.36% | 5.7 | 1293.8 |
| lizard L30 | 85,765,250 | 40.47% | 327.7 | 1243.4 |
| lz5 | 88,218,423 | 41.62% | 231.1 | 700.1 |
| misa77 L1 | 90,385,225 | 42.65% | 51.1 | 5148.6 |
| misa77 L-1 | 99,073,179 | 46.75% | 278.6 | 4789.1 |
| lz4 | 100,880,147 | 47.60% | 542.7 | 3617.4 |
| lz5 HC L1 | 113,525,877 | 53.57% | 511.5 | 1651.8 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| dickens | 9.7 MB | 28.26% | 37.56% | 27.96% | 27.77% | 27.99% | 33.00% | 36.87% | 63.07% |
| mozilla | 48.8 MB | 30.18% | 37.54% | 29.41% | 26.11% | 27.48% | 34.31% | 35.79% | 51.61% |
| mr | 9.5 MB | 33.25% | 33.86% | 31.16% | 27.58% | 28.34% | 34.20% | 37.92% | 54.57% |
| nci | 32.0 MB | 5.52% | 8.67% | 4.96% | 5.18% | 4.82% | 5.92% | 7.26% | 16.49% |
| ooffice | 5.9 MB | 44.39% | 57.43% | 42.18% | 39.45% | 40.31% | 50.21% | 49.35% | 70.53% |
| osdb | 9.6 MB | 30.76% | 34.55% | 30.74% | 28.26% | 28.01% | 33.78% | 37.30% | 52.12% |
| reymont | 6.3 MB | 20.88% | 31.39% | 20.35% | 19.87% | 20.15% | 23.34% | 27.09% | 48.00% |
| samba | 20.6 MB | 19.51% | 25.41% | 18.04% | 17.42% | 17.69% | 20.90% | 22.43% | 35.72% |
| sao | 6.9 MB | 69.75% | 79.46% | 68.95% | 60.88% | 63.29% | 73.89% | 78.09% | 93.63% |
| webster | 39.5 MB | 20.66% | 29.59% | 20.93% | 20.23% | 21.20% | 24.64% | 27.00% | 48.58% |
| x-ray | 8.1 MB | 57.02% | 57.02% | 60.53% | 52.98% | 55.30% | 66.91% | 75.46% | 99.01% |
| xml | 5.1 MB | 9.49% | 13.32% | 8.47% | 8.48% | 8.05% | 9.98% | 11.23% | 22.96% |

## Findings

**AIT: the lead is file D.** L15 is 38.78% on the 8 files against brotli
-11's 53.60% and zstd -19's 55.97%, decoding at 432 MB/s. Almost all of that
...
Without D, lz6 -15 is 45.74%: ahead of xz -9 and zstd -19, behind brotli
-11 and LZMA2 (uf-lzma2 -10/-11):

| codec | 8 files | without D | A | B | C | E | F | G | H |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| **lz6 -15** | **38.78%** | 45.74% | 54.75% | 18.44% | 27.04% | 79.53% | 79.39% | 29.32% | 40.12% |
...
zstd -19 (by 3.0, 0.4, 0.4 and 1.6 points), a gap the entropy-priced
...
**On Silesia lz6 -15 is 0.47 points behind zstd -19.** L15 is 25.43% @ 557
MB/s versus zstd -19's 24.96% @ 789 MB/s and brotli -11's 23.75% @ 371
MB/s. The gap was 1.56 points before the entropy-priced parser (v1.6.5-pre)
and 0.76 before the offset low-bits model (v1.6.6-pre); zstd -19 decodes
1.42x faster (2.0x before v1.6.4-pre). lizard -49 is 3.2 points behind lz6
at 2.2x the decode.
...
class; lz6 -15 trades 2.6 points of ratio for ~4.7x the decode. Level 11's
...
**Per file, lz6 L15 wins x-ray and webster** (57.02% vs 60.53%, 20.66%
vs 20.93%), ties osdb (30.76 vs 30.74) and is within 0.3 points of zstd -19
on dickens (28.26 vs 27.96). The remaining losses are the binary/structured
files, narrower since the offset low-bits model: sao 69.75 vs 68.95 (was
71.58), mozilla 30.18 vs 29.41 (was 31.06), ooffice 44.39 vs 42.18, mr
33.25 vs 31.16 and samba 19.51 vs 18.04.
...
**Decode speed remains lz6's weak axis vs zstd/lizard.** lz6's 430-570
MB/s band sits 1.4-3x below zstd (780-1380) and lizard (1200-1930), and
...
a strictly monotonic ladder: Silesia L1 33.42% -> L15 25.43%, every level
...
together (25.49 / 25.45 / 25.43%); deeper searches gave nothing past 64.
...
and 1.42x faster to decode on Silesia; the remaining ratio gap is in the
